...
public class lightcaster : MonoBehaviour
{
	...
	void Update()
    {
        ...
        objverts[0] = new Vector3(0, 0, 0);
		if (sceneObjects[0] != null) {objverts = sceneObjects[0].GetComponent<MeshFilter>().mesh.vertices;}
      ...
      void GetWalls()
      {
          ...
          {
              sceneObjects[i] = Colliders[i].gameObject;
          }
      }
}